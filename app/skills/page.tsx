...
const SkillPage = () => {
  ...
  return (
    <section className="relative my-5 flex h-screen w-full max-w-[1400px] animate-fade flex-col transition-all md:h-full md:w-[95vw] md:flex-row md:justify-around">
