      ...
      <div className="relative h-80 w-full">
        <div className="absolute bottom-0 right-0">
          <div className="group">
            ...
            <div className="absolute left-[-4px] top-[-173px] hidden w-max  flex-col items-center gap-1 p-0.5 group-hover:flex ">
              <div data-projection-id="1">
                <button className="border-blue-gray-50 m-0.5 flex min-h-[48px] min-w-[48px] flex-col items-center justify-center gap-1 rounded-full border bg-white p-1 font-normal transition-transform duration-300 ease-in-out hover:scale-110 focus:scale-110 active:scale-100">
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
                    fill="none"
                    viewBox="0 0 24 24"
